...
const navigation = [
   ...
   { name: 'Номера', href: '#accomodation' },
   { name: 'Отзывы', href: '#testimonials' },
   { name: 'Контакты', href: '#contactus' },
 ];
      ...
      <header className="absolute inset-x-0 top-0 z-50">
         ...
         <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
               ...
               <p className="text-3xl font-bold leading-6 text-gray-50">СТИМУЛ</p>
               </a>
            </div>
            ...
            <div className="hidden lg:flex lg:flex-1 lg:justify-end">
               ...
               Заказать <span aria-hidden="true">&rarr;</span>
               </a>
            </div>
         </nav>
         <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
            ...
            <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
               ...
               <a href="#" className="-m-1.5 p-1.5">
                  <p className="text-3xl font-bold leading-6 text-gray-800">СТИМУЛ</p>
               </a>
               <button
                  type="button"
